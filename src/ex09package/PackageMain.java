...
/*
 임폴트 선언부 : 현재 작성하는 클래스에서 다른 클래스를 가져다쓰기위한
 	선언으로 클래스가 생성된 패키지명과 클래스명을 함께 작성하면 된다.
 	만약 해당 패키지 하위에 선언된 모든 클래스를 한꺼번에 임폴트하고 싶다면
...
public class PackageMain 
{
	...
	public static void main(String[] args) 
	{
		/*
		 ...
		 방법2 : 하나의 클래스는 import하고, 다른하나는 패키지명
		 	전체를 기술한다.
		 */
		
		//방법2를 차용하여 import 후 사용
		...
		/*
		ex09package 하위에 ex09package.kosme.util 패키지가 생성되지만
		이 둘은 서로 다른 패키지로 인식한다.
		따라서 isNumber() 메소드를 호출하기 위해 반드시 해당 패키지를
		import 해야한다.
		 */
		String strValue = "9876543421";
