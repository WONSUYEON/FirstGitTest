...
class Point {
	...
	/*
	객체1,2의 x,y 값을 동시에 비교해서 둘다 동일할때 
	같은 객체로 판단한다. 만약 하나의 값만 비교하고 싶다면
	조건을 수정하면 된다.
	 */
	@Override
	public boolean equals(Object obj)
...
public class E04Object3Equals
{
	...
	public static void main(String[] args)
	{
		...
		}//는는은 그저 주소가 같냐 다르냐만 물어보고 당연히 주소는 다르져..
		//힙에 저장되는 주소값 다 다른거...
		else {
		...
		//이퀄스는 알맹이가 같냐 다르냐 ??
		//이퀄스는 객체간의 내용이 같냐다르냐를 구분하는거
		
		
		/*
		println()은 출력전에 항상 객체의 toString()메소드를 자동으로
		호출하므로 아래 출력결과는 동일하다
		 */
