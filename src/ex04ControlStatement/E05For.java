...
public class E05For {
	...
	public static void main(String[] args) {
		...
		/*
		시나리오] for문을 이용하여 1~10사이의 정수중 2의배수 
		구하는 프로그램을 작성하시오.
		 */
		int total = 0;
		//방법1 : 
...
//	}
	...
	for(int j=0 ; j<=5 ; j++);//원래는 6번 실행되야하는데 맨뒤에 세미콜론때문에 한번만 실행되는 잘못된 경우이다	
	{
		System.out.println("어랏...나는누구? 여긴 어디?");
	}
	...
	가지고 있다.
	 */
	//System.out.println("위 for문에서 선언한 변수 j=" + j);//오류나는게 맞아 j는 지역을 벗어났어
	...
	*/ 
	...
	for(int dan=2; dan<=9 ; dan++){//2단부터 9단까지 반복
		...
		//	System.out.printf("%dx%d=%2d ",dan, su,(dan*su)); 
			System.out.printf("%dx%d=%2d%n",dan,su,(dan*su));
