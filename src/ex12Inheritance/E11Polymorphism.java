...
class Child extends Parent{
	...
	void parentMethod()
	{
		System.out.println("자식에서 Overring한 메소드 "+"parentMethod()");
		super.parentMethod();
	}
	//오버로딩된 메소드(확장한 메소드)
...
public class E11Polymorphism
{
	...
	public static void main(String[] args)
	{
		...
		//parent1.childMember =1;//접근불가 -> 부모타입으로 자식멤버에 접근할수 없다.
		...
		//방법2: 자식타입의 참조변수에 (담아서)할당한 후 접근한다.
