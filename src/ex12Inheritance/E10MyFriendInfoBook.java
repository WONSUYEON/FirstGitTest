...
class Friend{
	...
	/*
	간략 정보를 출력하는 용도의 멤버메소드로 실행부가 없는
...
class FriendInfoHandler{
	...
	public void addFriend(int choice) {
		...
		3. numOfFriends를 1 증가시킨다. 후위증가이므로 이렇게 처리한다.
		 */
		if(choice==1) { //고딩친구
	...
	3. 정보 출력시 배열에 입력된 객체수만큼 반복하면서 각 요소를 통해
		멤버메소드를 호출한다.
	4. 이때 오버라이딩된 메소드를 통해 항상 객체의 정보를 출력할수 
		있다. 참조변수의 타입에 영향을 받지않고 항상 오버라이딩된
		최하위의 메소드가 호출되기 때문이다.
	 */
...
public class E10MyFriendInfoBook
{
	...
	/*
	프로그램 전반의 흐름에 대해서만 기술하고 관련 메소드를
	...
	public static void main(String[] args)
	{
		...
		//초기값으로 100명의 정보를 저장할수 있는 Friend타입의 객체배열생성
