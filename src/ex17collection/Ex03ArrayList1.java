...
public class Ex03ArrayList1
{
	...
	public static void main(String[] args)
	{
		...
		System.out.println("중복 저장후 객체수:"+list.size());//7개출력
		...
		1-6] 포함여부확인
			...
			만약 포함되어 있다면 true를 반환한다. 있는지만 확인가능하고 
			몇번째에 있는지 위치한 인덱스 까지는 확인할수 없다
		 */
		...
		방법1 : 인덱스로 삭제한다. 삭제가 완료되면 삭제된 객체를 반환한다.
			...
			삭제성공시 해당 객체를 반환하므로 어떤 객체를 삭제했는지 확인할수있다.
		 */
		Object obj = list.remove(2);
		System.out.println("방법1)삭제된객체:"+obj);
