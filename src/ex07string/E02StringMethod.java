...
public class E02StringMethod {
	...
	public static void main(String[] args) {
		...
		//문자열에서 문자 하나를 뽑아 비교하므로 싱글코세이션을 사용해야한다.
		...
		/*
		 3]compareTo()
		 	...
		 	앞문자열의 아스키코드가 크면 양수를 반환하고
		 	뒷 문자열의 아스키코드가 크면 음수를 반환하
		 	두문자열을 같을때 
		 */
		String str3 ="A";
		String str4 ="B";
		...
		/*
		 15.codePointAt(인덱스) : 문자열의 특정 인덱스의 문자를 찾은후
		 	아스키코드(유니코드)를 반환한다.
		 */
